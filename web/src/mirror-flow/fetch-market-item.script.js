  ...
  return fcl
    .send([
      ...
      pub fun main(address: Address, id: UInt64): Item? {
        if let collection = getAccount(address).getCapability<&MirrorItemsMarket.Collection{MirrorItemsMarket.CollectionPublic}>(MirrorItemsMarket.CollectionPublicPath).borrow() {
